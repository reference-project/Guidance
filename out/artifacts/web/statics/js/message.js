...
function messagePrompt(result){
    ...
    //遮罩层样式
    var messagePromptStyle="filter:alpha(opacity=1);opacity:1;border:1px solid #009ACD;width:"+width+"px;padding-bottom: 8px; background-color: #F8F8FF;position: fixed;top: "+width+"px;left: "+left+"px;margin:0 auto;z-index:10000;display:none;border-radius:4px;"
